...
import ru.innopolis.bootcamp22.day2.streams.model.*;
import ru.innopolis.bootcamp22.day2.streams.util.AveragingBigDecimalCollector;
 ...
 *
 * Refer to the <code>model</code> package to observe the domain model of the shop.
 */
class OrderStats {
